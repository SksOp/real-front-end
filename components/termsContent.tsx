    ...
    <div className="flex flex-col gap-4 w-full pt-12 md:pt-4 px-2 pb-4">
      <div className="flex flex-col gap-2">
        ...
        <p className="text-muted-foreground text-base font-normal">
          By accessing or using KeyPilot LLC’s services, including our website,
          app, and related tools, you agree to comply with these Terms and
          Conditions ("Terms"). Please read them carefully. If you do not agree
      ...
      <div className="flex flex-col gap-2">
        ...
        <p className="text-muted-foreground text-base font-normal">
          ...
          digital services for real estate professionals. Our data and analytics
          are sourced and regulated in alignment with Dubai Land Department and
          other UAE government standards.
        </p>
      </div>
      <div className="flex flex-col gap-2">
        <h3 className="text-muted-foreground text-base font-bold">
      ...
      <div className="flex flex-col gap-2">
        ...
        <ul className="list-disc pl-5 text-muted-foreground text-base font-normal">
          ...
          <li>
            Use the services only for lawful purposes and as permitted by these
            Terms.
          </li>
      ...
      <div className="flex flex-col gap-2">
        ...
        <p className="text-muted-foreground text-base font-normal">
          ...
          estate professionals. While we strive to maintain accurate and current
          data, we cannot guarantee complete accuracy or applicability. Users
          acknowledge that KeyPilot LLC is not liable for decisions made based
          on our data.
        </p>
      </div>
      <div className="flex flex-col gap-2">
      ...
      <div className="flex flex-col gap-2">
        ...
        <p className="text-muted-foreground text-base font-normal">
          ...
          affiliates, employees, and partners from any claims or demands arising
          out of their use of our services or violation of these Terms.
        </p>
      </div>
      <div className="flex flex-col gap-2">
        <h3 className="text-muted-foreground text-base font-bold">
        ...
        <p className="text-muted-foreground text-base font-normal">
          KeyPilot LLC reserves the right to update these Terms at any time. We
          will notify users of significant changes. Your continued use of the
