    ...
    <Card className="border-0 mb-20">
        ...
        <div className="flex flex-col gap-4 justify-center items-center w-full">
          <div className="flex justify-start gap-6 items-center w-full">
            ...
            <div className="flex flex-col gap-2 items-start justify-center">
              <h3 className="text-muted">Down Payment</h3>
          ...
          <div className="flex justify-start gap-6 items-center w-full">
            <MonthlyPaymentIcon />
            <div className="flex flex-col gap-2 items-start justify-center">
              <h3 className="text-muted">Monthly Payment</h3>
          ...
          <div className="flex justify-start gap-6 items-center w-full">
            <InterstRateIcon />
            <div className="flex flex-col gap-2 items-start justify-center">
              <h3 className="text-muted">Interest Rate</h3>
          ...
          <div className="flex justify-start gap-6 items-center w-full">
            <DurationIcon />
            <div className="flex flex-col gap-2 items-start justify-center">
              <h3 className="text-muted">Duration (Years)</h3>
      ...
      <CardFooter className="w-full">
        {isCalculatorOpen ? (
          <Button
            variant={"secondary"}
            className="text-primary hover:bg-secondary py-8 font-bold rounded-full border-2 w-full"
