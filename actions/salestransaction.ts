import { SalesChartDataTypeMonthly, SalesChartDataTypeQuaterly, SalesChartDataTypeYearly } from "@/components/sales-market-trend/sales-market-trend";
import { SalesTransactionsType } from "@/transcation/types";

export class SalesTransactions {
    getYearlySalesData({ data }: { data: SalesTransactionsType }): SalesChartDataTypeYearly[] {
    ...
    getQuarterlySalesData({ data }: { data: SalesTransactionsType }): SalesChartDataTypeQuaterly[] {
    ...
    getMonthlySalesData({ data }: { data: SalesTransactionsType }): SalesChartDataTypeMonthly[] {
