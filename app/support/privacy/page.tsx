      ...
      <div className="flex flex-col gap-4 w-full pt-12 md:pt-20 px-2 pb-4">
        <div className="flex flex-col gap-2">
          ...
          <p className="text-muted-foreground text-base font-normal">
            ...
            in compliance with UAE data protection laws and global GDPR
            practices.
          </p>
        </div>
        <div className="flex flex-col gap-2">
          ...
          <ul className="list-disc pl-5 text-muted-foreground text-base font-normal">
            <li>
              Personal Information: When you register or use our services, we
        ...
        <div className="flex flex-col gap-2">
          ...
          <p className="text-muted-foreground text-base font-normal">
            ...
            third parties for service provision, compliance, and legal
            requirements. These parties are required to maintain the
        ...
        <div className="flex flex-col gap-2">
          ...
          <p className="text-muted-foreground text-base font-normal">
            ...
            data. While we strive to ensure data security, no system is entirely
